...
public class MainActivity extends AppCompatActivity {
    ...
    private void toggleTheme() {
        if (themeSettings.getBoolean("MODE_NIGHT_ON", false)) {
            ...
            settingsEditor.putBoolean("MODE_NIGHT_ON", false);
            settingsEditor.apply();
            Toast.makeText(MainActivity.this, "Тёмная тема off", Toast.LENGTH_SHORT).show();
        } else {
            AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES);
            settingsEditor = themeSettings.edit();
            settingsEditor.putBoolean("MODE_NIGHT_ON", true);
            settingsEditor.apply();
            Toast.makeText(MainActivity.this, "Тёмная тема on", Toast.LENGTH_SHORT).show();
        }
        updateImageButton();
    }
    ...
    private void checkGameState() {
        ...
        if (winner != null) {
            Toast.makeText(this, "Этот бро победил: " + winner, Toast.LENGTH_SHORT).show();
            saveStats(winner);
            gameOver = true;
    ...
    private void loadStats() {
        ...
        statsView.setText("Счет крестиков: " + xWins + " Счет ноликов: " + oWins + " Счет ничьи: " + draws);
    }
